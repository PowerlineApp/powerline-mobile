angular.module('app').run(function ($location, layout, spinnerIndicator, $rootScope,
        ...
        groupsInvites, announcements, invites, follows, ionicToast, pushNotificationCallbacks) {
  ...
  pushNotificationCallbacks.initialize()
  ...
  $rootScope.isDefaultAvatar = function (avatarUrl) {
    return (avatarUrl && avatarUrl.indexOf('default_') > -1)
};
